...
```
    ...
    <ipython-input-14-44cc82a0ac87> in <module>
    ----> 1 df_can.set_index('Country', inplace=True)
          2 
          3 # let's view the first five elements and see how the dataframe was changed
          4 df_can.head()
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f4a72707a20>
...
```python
### type your answer here
df_t1 = df_can.loc[['Greece', 'Albania', 'Bulgaria'], years].transpose()
df_t1.head()

count,bin_edges = np.histogram(df_t1,15)
...
```python
### type your answer here
df_can15.plot(kind='barh', figsize=(10, 6))
...
```
    ...
    Text(0.5, 1.0, 'Total Immigrants to Canada from 1980 to 2013')
